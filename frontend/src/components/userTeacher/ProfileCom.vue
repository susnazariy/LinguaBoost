  ...
  <div class="profile-back">
    <div class="profile-left">
      ...
      <nav class="sidebars">
        <ul>
          <li>
            <router-link to="/profile-teacher/settings">
              <i class="fas fa-cogs"></i> Налаштування профілю
            </router-link>
          </li>
          <li>
            <router-link to="/profile-teacher/courses">
              <i class="fas fa-book-open"></i> Створені курси
            </router-link>
          </li>
          <li>
            <router-link to="/profile-teacher/requests">
              <i class="fas fa-envelope"></i> Заявки на курси
            </router-link>
          </li>
        </ul>
      </nav>
